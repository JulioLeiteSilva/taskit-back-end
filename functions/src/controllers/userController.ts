...
export const createUser = async (
  request: functions.https.CallableRequest<User>
) => {
  if (!request.auth) {
...
export const getUser = async (
  request: functions.https.CallableRequest<{ uid: string }>
) => {
...
export const updateUser = async (
  request: functions.https.CallableRequest<Partial<User>>
) => {
  if (!request.auth) {
    throw new functions.https.HttpsError(
      "unauthenticated",
